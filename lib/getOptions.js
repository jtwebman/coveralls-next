 ...
 * @param {Function} cb - Callback function (err, options)
 * @returns {void}
 * @throws {Error} Via callback if git data fetching fails
 */
 ...
 * @returns {void}
 * @throws {Error} If callback is not provided or if option fetching fails
 */
