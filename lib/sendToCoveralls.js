 ...
 * @param {Function} cb - Callback function (err, response)
 * @param {number} cb.response.statusCode - HTTP status code
 * @param {string} [cb.response.body] - Response body text
 * @returns {Promise<void>} Async function that calls callback when complete
 */
